...
//    }
    ...
    self.paceLabel.text = [NSString stringWithFormat:@"Pace : %@",[MathController stringifyAvgPaceFromDist:self.run.distance.floatValue overTimes:self.run.duration.intValue]];
...
else
{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Sorry , No record" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
    [alertView show];
